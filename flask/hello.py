...
from flask import Flask, render_template, url_for, flash, redirect  # render - return 으로 해당 html 나옴 // url_for 템플릿 {{ url_for('home')}} (/home) 아님 // flash - like a popup // redirect(url_for('about') 이동
from forms import RegistrationForm, LoginForm  # 내가 만든 forms.py 정의한 함수(RegistrationForm, LoginForm) import
app = Flask(__name__)
